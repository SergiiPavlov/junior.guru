...
## Быстрый старт
1) Установи Node 20+ и npm 10+ (npm 7+ с поддержкой workspace:*, в CI закреплен npm 10.8.1)
...
- На странице `/[locale]/jobs` появилась кнопка «Допомога ШІ» / «AI helper». Вона відкриває модалку з текстовим полем, підказкою країни та чекбоксом remote only.
